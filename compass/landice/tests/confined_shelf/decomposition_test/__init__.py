...
from compass.landice.tests.confined_shelf.setup_mesh import SetupMesh
from compass.landice.tests.confined_shelf.run_model import RunModel
from compass.landice.tests.confined_shelf.visualize import Visualize


class DecompositionTest(TestCase):
    """
    A test case for performing two MALI runs of a confined shelf setup, one

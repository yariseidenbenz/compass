...
class Visualize(Step):
    """
    A step for visualizing the output from a confined_shelf test case
    ...
    def run(self):
        ...
        """
        visualize_confined_shelf(self.config, self.logger,
                                 filename='output.nc')


def visualize_confined_shelf(config, logger, filename):
    """
    Plot the output from a confined_shelf test case
    ...
    filename : str
        file to visualize
    """
    section = config['confined_shelf_viz']
